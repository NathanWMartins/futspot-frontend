...
import LocalDialog, { type LocalFormValues } from "../../components/locador/DialogEditarLocal";
...
export default function LocadorHome() {
  ...
  async function carregarLocais() {
    ...
    try {
      ...
      const msg =
        e?.response?.data?.message ?? e?.message ?? "Erro ao carregar locais.";
      setErrorMsg(msg);
      setLocais([]);
    } finally {
      setLoading(false);
              ...
              {!loading && locais.length === 0 ? (
                <Box sx={{ py: 4, textAlign: "center", opacity: 0.85 }}>
                  ...
                  <Typography sx={{ fontSize: 14, opacity: 0.7, mt: 0.5 }}>
                    Cadastre sua primeira quadra para liberar horários e receber
                    reservas.
                  </Typography>
                  <Button
                    variant="contained"
                    ...
                    return (
                      ...
                      >
                        ...
                        <Box sx={{ flex: 1 }}>
                          ...
                          <Typography
                            sx={{ fontSize: 14, opacity: 0.85, mt: 1 }}
                          >
                        ...
                        <Box
                          sx={{
                            ...
                            pt: { xs: 1.2, sm: 0 },
                            borderTop: {
                              xs: "1px solid rgba(0, 230, 118, 0.12)",
                              sm: "none",
                            },
                          }}
                        >
                          ...
                          <Box sx={{ width: "100%" }}>
                            ...
                            <Typography
                              sx={{ mt: 0.4, fontSize: 12.5, opacity: 0.65 }}
                            >
