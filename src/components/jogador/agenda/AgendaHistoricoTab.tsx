...
export default function AgendaHistoricoTab({
  loading,
  lista,
  onAvaliar,
}: Props) {
  ...
  if (!lista.length) {
    return (
      ...
      >
        <CardContent>
          <Typography fontWeight={900}>Sem histórico ainda</Typography>
          <Typography sx={{ opacity: 0.75, mt: 0.5, fontSize: 13 }}>
            Depois que seus jogos passarem, eles aparecem aqui para avaliação.
          </Typography>
        </CardContent>
      </Card>
    );
